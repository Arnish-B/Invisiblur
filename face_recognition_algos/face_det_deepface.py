...
def blurThis(the_fileName):
    ...
    while cap.isOpened():
        ...
        if ret:
            ...
            detected_face = DeepFace.extract_faces(img, detector_backend='mtcnn', enforce_detection=False)
    ...
    out = cv2.VideoWriter("deepface_video_test_processed.mp4", cv2.VideoWriter_fourcc(*"XVID"), 15, size)
